...
const translations = {
  en: {
    ...
    'ojrn.close':             'Close',
    'ojrn.local_badge':       'From Shoptimize pixel',
    'ojrn.local_note':        'Shopify recorded no journey for this order. This timeline comes from our own pixel, which does not depend on Shopify analytics cookies.',
    'ojrn.steps':             'Steps',
    'ojrn.source_step':       'Traffic source',
    'ojrn.ch.paid_social':    'Paid Social',
    'ojrn.ch.paid_search':    'Paid Search',
    'ojrn.ch.paid':           'Paid',
    'ojrn.ch.organic_search': 'Organic Search',
    'ojrn.ch.social':         'Social',
    'ojrn.ch.email':          'Email',
    'ojrn.ch.referral':       'Referral',
    'ojrn.ch.direct':         'Direct',
    'vis.search':             'Search visitor, product, source…',
    'vis.only_orders':        'Orders only',
    'vis.no_match':           'No visitor matches',
    'feed.search':            'Search event, product, order…',
    'feed.only_orders':       'Orders only',
    'feed.no_match':          'No event matches',
    'ojrn.ev.page_viewed':       'Page view',
    'ojrn.ev.product_viewed':    'Product view',
    'ojrn.ev.collection_viewed': 'Collection view',
    'ojrn.ev.cart_viewed':       'Cart view',
    'ojrn.ev.search_submitted':  'Search',
    'ojrn.ev.add_to_cart':       'Added to cart',
    'ojrn.ev.checkout_started':  'Checkout started',
    'ojrn.ev.checkout_completed':'Order placed',
    ...
    'flow.es_connect':      'Connect with WhatsApp',
    'flow.es_hint':         'Sign in with Facebook and pick your WhatsApp number — everything is set up automatically.',
    'flow.es_or_token':     'or connect with a token',
    'flow.es_reconnect':    'Reconnect with Facebook',
    'flow.es_reconnect_hint':'Already connected — reconnect via Facebook to enable delivery/read receipts and opt-out.',
    'flow.es_cancelled':    'Connection cancelled.',
    'flow.es_sdk_fail':     'Could not load Facebook. Try again.',
    'flow.quick_connect':   'Quick Connect',
    'flow.quick_connect_hint': 'Just paste your WhatsApp token — Phone ID and WABA ID are found automatically.',
    'flow.connect_btn':     'Connect',
    'flow.or_manual':       'or enter the fields manually below',
    'flow.qc_success':      'Connected! Number: {phone}',
    'flow.qc_fail':         'Could not connect. Check your token.',
    ...
    'flow.post_order_lbl':  'converted to order',
    'flow.optout':          'Opt-out',
    ...
    'campaign.warn_image':    'This template uses an IMAGE header — fill in the "Image" field.',
    'campaign.warn_coupon':   'This template has a COUPON button — fill in the "Coupon code" field.',
    'campaign.warn_header_unsupported': 'This template uses a {fmt} header — only image headers are supported right now.',
    'campaign.fields_ok':     'All required fields for this template are filled.',
    'campaign.hdr_label':     'Header:',
    'campaign.hdr_none':      'none',
    'campaign.hdr_text':      'text',
    'campaign.hdr_image':     'image',
    'campaign.hdr_video':     'video',
    'campaign.hdr_document':  'document',
    'campaign.var_label':     'Variables:',
    'campaign.coupon_chip':   'Coupon button',
    'campaign.preview':       'Preview',
    'campaign.img_placeholder':'image goes here',
    'campaign.preview_name':  'Customer',
    'campaign.preview_msg':   '(your message)',
    'campaign.preview_camp_msg':'(your campaign message)',
    'campaign.coupon_word':   'COUPON',
    'campaign.add_coupon_btn':'Add a "copy coupon code" button',
    'campaign.coupon_example_ph':'Example coupon code (e.g. SAVE10)',
    'campaign.coupon_label':  'Coupon code (optional)',
    'campaign.coupon_hint':   'Only needed for templates with a "copy coupon code" button. The code is copied when the customer taps the button.',
    'campaign.confirm_title': 'Confirm send',
    'campaign.confirm_send_now': 'The "{tpl}" template will be sent to {count} people. This cannot be undone — sending starts immediately.',
    'campaign.confirm_schedule': 'The "{tpl}" template will be scheduled for {count} people.',
    'campaign.confirm_cancel':'Cancel',
    'campaign.confirm_yes_send':'Yes, send to {count} people',
    'campaign.confirm_yes_schedule':'Yes, schedule',
    'campaign.tpl_lang':      'Template language',
    'campaign.step1':         'Template',
    'campaign.step2':         'Content & Audience',
    'campaign.step3':         'Review & Send',
    'campaign.next':          'Next',
    'campaign.back':          'Back',
    'campaign.review_title':  'Review',
    'campaign.step_of':       'Step {n} of 3',
    'campaign.tpl_name':      'Template name',
    'campaign.tpl_name_ph':   'e.g. summer_sale',
    'campaign.tpl_name_hint': 'Your own name for this template (lowercase letters, numbers and _ only).',
    'campaign.tpl_content':   'Content template (ready-made text)',
    'campaign.need_name':     'Please enter a template name.',
    'campaign.details':       'Details',
    'campaign.no_recipients': 'No recipient data for this campaign yet.',
    'campaign.col_person':    'Customer',
    'campaign.col_product':   'Product',
    'campaign.recip_note':    '✅ delivered / read comes from WhatsApp; order is matched by phone (within 14 days after sending).',
    'mon.enter':              'Live Mode',
    'mon.title':              'Live Mode',
    'mon.exit':               'Exit',
    'mon.sound':              'Sound',
    'mon.live_visitors':      'Live visitors',
    'mon.today_revenue':      "Today's revenue",
    'mon.wa_recovered':       'WA recovered',
    'mon.today_orders':       "Today's orders",
    'mon.conversion':         'Conversion',
    'mon.orders':             'orders',
    'mon.funnel':             'Funnel',
    'mon.f_views':            'Product views',
    'mon.f_cart':             'Add to cart',
    'mon.f_checkout':         'Checkout',
    'mon.f_orders':           'Orders',
    'mon.wa_title':           'WhatsApp / Recovery',
    'mon.abandoned':          'Abandoned',
    'mon.recovered_orders':   'Recovered orders',
    'mon.recovered_rev':      'Recovered revenue',
    'mon.recovery_rate':      'Recovery rate',
    'mon.live_feed':          'Live feed',
    'mon.waiting':            'Waiting for activity…',
    'mon.at_risk':            'At-risk carts',
    'mon.no_risk':            'No at-risk carts right now.',
    'mon.in_checkout':        'CHECKOUT',
    'mon.in_cart':            'CART',
    'mon.min_idle':           'min idle',
    'mon.hot':                'Hot products',
    'mon.no_hot':             'No hot products right now.',
    'mon.viewers':            'viewers',
    'mon.order':              'Order received',
    'mon.checkout_started':   'Checkout started',
    'mon.new_cart':           'New cart',
    'mon.viewing':            'Viewing product',
    'mon.search':             'Search',
    'mon.fullscreen':         'Fullscreen',
    'mon.today':              'today',
    'mon.total':              'total',
    'mon.avg_recovered':      'Avg recovered cart',
    'mon.top_products':       'Top products',
    'mon.no_data':            'No data yet.',
    'mon.rotate':             'Auto-rotate',
    'mon.goal':               "Today's revenue goal",
    'mon.hourly':             'Hourly trend (recovered ₺)',
    'mon.hourly_sub':         'Recovered revenue by hour (today)',
    'mon.vs_yesterday':       'Today vs yesterday',
    'mon.yesterday':          'Yesterday',
    'mon.traffic':            'Traffic sources',
    ...
    'plan.activate_now':   'Activate Subscription',
    'plan.subscribe_prompt': 'Subscribe to keep using Shoptimize Live. A free trial is provided by Shopify on the plan page.',
  ...
  tr: {
    ...
    'ojrn.close':             'Kapat',
    'ojrn.local_badge':       'Shoptimize pixel verisi',
    'ojrn.local_note':        'Shopify bu sipariş için yolculuk kaydı tutmamış. Bu çizelge, Shopify analitik çerezlerine bağlı olmayan kendi pixel verimizden geliyor.',
    'ojrn.steps':             'Adım',
    'ojrn.source_step':       'Geldiği kaynak',
    'ojrn.ch.paid_social':    'Ücretli Sosyal',
    'ojrn.ch.paid_search':    'Ücretli Arama',
    'ojrn.ch.paid':           'Ücretli',
    'ojrn.ch.organic_search': 'Organik Arama',
    'ojrn.ch.social':         'Sosyal',
    'ojrn.ch.email':          'E-posta',
    'ojrn.ch.referral':       'Yönlendirme',
    'ojrn.ch.direct':         'Doğrudan',
    'vis.search':             'Ziyaretçi, ürün, kaynak ara…',
    'vis.only_orders':        'Sadece sipariş verenler',
    'vis.no_match':           'Eşleşen ziyaretçi yok',
    'feed.search':            'Etkinlik, ürün, sipariş ara…',
    'feed.only_orders':       'Sadece siparişler',
    'feed.no_match':          'Eşleşen etkinlik yok',
    'ojrn.ev.page_viewed':       'Sayfa görüntüleme',
    'ojrn.ev.product_viewed':    'Ürün görüntüleme',
    'ojrn.ev.collection_viewed': 'Koleksiyon görüntüleme',
    'ojrn.ev.cart_viewed':       'Sepet görüntüleme',
    'ojrn.ev.search_submitted':  'Arama',
    'ojrn.ev.add_to_cart':       'Sepete ekledi',
    'ojrn.ev.checkout_started':  'Ödemeye başladı',
    'ojrn.ev.checkout_completed':'Sipariş verdi',
    ...
    'flow.wa_token':        'WhatsApp Token',
    'flow.es_connect':      'WhatsApp ile Bağlan',
    'flow.es_hint':         'Facebook ile giriş yap ve WhatsApp numaranı seç — her şey otomatik kurulur.',
    'flow.es_or_token':     'veya token ile bağlan',
    'flow.es_reconnect':    'Facebook ile Yeniden Bağlan',
    'flow.es_reconnect_hint':'Zaten bağlı — iletildi/okundu ve opt-out için Facebook ile yeniden bağlan.',
    'flow.es_cancelled':    'Bağlantı iptal edildi.',
    'flow.es_sdk_fail':     'Facebook yüklenemedi. Tekrar deneyin.',
    'flow.quick_connect':   'Hızlı Bağlan',
    'flow.quick_connect_hint': 'Sadece WhatsApp token\'ını yapıştır — Phone ID ve WABA ID otomatik bulunur.',
    'flow.connect_btn':     'Bağlan',
    'flow.or_manual':       'veya aşağıdaki alanları manuel gir',
    'flow.qc_success':      'Bağlandı! Numara: {phone}',
    'flow.qc_fail':         'Bağlanılamadı. Token\'ı kontrol edin.',
    ...
    'flow.post_order_lbl':  'siparişe dönüştü',
    'flow.optout':          'Opt-out',
    ...
    'campaign.warn_image':    'Bu şablon GÖRSEL başlık kullanıyor — "Görsel" alanını doldurmalısın.',
    'campaign.warn_coupon':   'Bu şablonda KUPON butonu var — "Kupon kodu" alanını doldurmalısın.',
    'campaign.warn_header_unsupported': 'Bu şablon {fmt} başlık kullanıyor — şu an sadece görsel başlık destekleniyor.',
    'campaign.fields_ok':     'Bu şablon için gerekli alanlar tamam.',
    'campaign.hdr_label':     'Başlık:',
    'campaign.hdr_none':      'yok',
    'campaign.hdr_text':      'metin',
    'campaign.hdr_image':     'görsel',
    'campaign.hdr_video':     'video',
    'campaign.hdr_document':  'belge',
    'campaign.var_label':     'Değişken:',
    'campaign.coupon_chip':   'Kupon butonu',
    'campaign.preview':       'Önizleme',
    'campaign.img_placeholder':'görsel buraya gelecek',
    'campaign.preview_name':  'Müşteri',
    'campaign.preview_msg':   '(mesajınız)',
    'campaign.preview_camp_msg':'(kampanya mesajınız)',
    'campaign.coupon_word':   'KUPON',
    'campaign.add_coupon_btn':'Kupon kodu kopyala butonu ekle',
    'campaign.coupon_example_ph':'Örnek kupon kodu (örn. INDIRIM10)',
    'campaign.coupon_label':  'Kupon kodu (opsiyonel)',
    'campaign.coupon_hint':   'Sadece "kupon kodu kopyala" butonlu şablonlarda gerekir. Müşteri butona basınca bu kod kopyalanır.',
    'campaign.confirm_title': 'Gönderimi onayla',
    'campaign.confirm_send_now': '{count} kişiye "{tpl}" şablonu gönderilecek. Bu işlem geri alınamaz — gönderim hemen başlar.',
    'campaign.confirm_schedule': '{count} kişiye "{tpl}" şablonu planlanacak.',
    'campaign.confirm_cancel':'Vazgeç',
    'campaign.confirm_yes_send':'Evet, {count} kişiye gönder',
    'campaign.confirm_yes_schedule':'Evet, planla',
    'campaign.tpl_lang':      'Şablon dili',
    'campaign.step1':         'Şablon',
    'campaign.step2':         'İçerik & Kitle',
    'campaign.step3':         'Özet & Gönder',
    'campaign.next':          'İleri',
    'campaign.back':          'Geri',
    'campaign.review_title':  'Özet',
    'campaign.step_of':       'Adım {n} / 3',
    'campaign.tpl_name':      'Şablon adı',
    'campaign.tpl_name_ph':   'örn. yaz_kampanyasi',
    'campaign.tpl_name_hint': 'Bu şablona vereceğin kendi adın (yalnız küçük harf, rakam ve _ ).',
    'campaign.tpl_content':   'İçerik şablonu (hazır metin)',
    'campaign.need_name':     'Lütfen bir şablon adı girin.',
    'campaign.details':       'Detay',
    'campaign.no_recipients': 'Bu kampanya için henüz alıcı verisi yok.',
    'campaign.col_person':    'Müşteri',
    'campaign.col_product':   'Ürün',
    'campaign.recip_note':    '✅ iletildi / okundu WhatsApp\'tan gelir; sipariş telefonla eşleştirilir (gönderimden sonraki 14 gün içinde).',
    'mon.enter':              'Canlı Mod',
    'mon.title':              'Canlı Mod',
    'mon.exit':               'Çıkış',
    'mon.sound':              'Ses',
    'mon.live_visitors':      'Canlı ziyaretçi',
    'mon.today_revenue':      'Bugünkü ciro',
    'mon.wa_recovered':       'WA kurtarılan',
    'mon.today_orders':       'Bugünkü sipariş',
    'mon.conversion':         'Dönüşüm',
    'mon.orders':             'sipariş',
    'mon.funnel':             'Huni',
    'mon.f_views':            'Ürün görüntüleme',
    'mon.f_cart':             'Sepete ekleme',
    'mon.f_checkout':         'Ödeme',
    'mon.f_orders':           'Sipariş',
    'mon.wa_title':           'WhatsApp / Kurtarma',
    'mon.abandoned':          'Terk edilen',
    'mon.recovered_orders':   'Kurtarılan sipariş',
    'mon.recovered_rev':      'Kurtarılan ciro',
    'mon.recovery_rate':      'Kurtarma oranı',
    'mon.live_feed':          'Canlı akış',
    'mon.waiting':            'Hareket bekleniyor…',
    'mon.at_risk':            'Risk altındaki sepetler',
    'mon.no_risk':            'Şu an riskli sepet yok.',
    'mon.in_checkout':        'ÖDEME',
    'mon.in_cart':            'SEPET',
    'mon.min_idle':           'dk hareketsiz',
    'mon.hot':                'Hot ürünler',
    'mon.no_hot':             'Şu an hot ürün yok.',
    'mon.viewers':            'kişi bakıyor',
    'mon.order':              'Sipariş geldi',
    'mon.checkout_started':   'Ödemeye başladı',
    'mon.new_cart':           'Yeni sepet',
    'mon.viewing':            'Ürün inceliyor',
    'mon.search':             'Arama',
    'mon.fullscreen':         'Tam ekran',
    'mon.today':              'bugün',
    'mon.total':              'toplam',
    'mon.avg_recovered':      'Ort. kurtarılan sepet',
    'mon.top_products':       'Top ürünler',
    'mon.no_data':            'Henüz veri yok.',
    'mon.rotate':             'Otomatik döngü',
    'mon.goal':               'Günlük ciro hedefi',
    'mon.hourly':             'Saatlik trend (kurtarılan ₺)',
    'mon.hourly_sub':         'Saate göre kurtarılan ciro (bugün)',
    'mon.vs_yesterday':       'Bugün vs dün',
    'mon.yesterday':          'Dün',
    'mon.traffic':            'Trafik kaynakları',
    ...
    'plan.activate_now':   'Aboneliği Aktive Et',
    'plan.subscribe_prompt': 'Shoptimize Live\'ı kullanmaya devam etmek için abone olun. Ücretsiz deneme, plan sayfasında Shopify tarafından sunulur.',
