...
const translations = {
  en: {
    ...
    'flow.guide_intro':     'Follow these steps to connect your WhatsApp Business account:',
    'flow.guide_step1_title': 'Create a Meta Business Account',
    'flow.guide_step1_desc':  'Go to business.facebook.com and create or log in to your Meta Business account.',
    'flow.guide_step2_title': 'Create a Meta Developer App',
    'flow.guide_step2_desc':  'Go to developers.facebook.com/apps → Create App → Business type → Add WhatsApp product.',
    'flow.guide_step3_title': 'Add a WhatsApp Phone Number',
    'flow.guide_step3_desc':  'In your app: WhatsApp → Phone Numbers → Add Number. Complete phone verification.',
    'flow.guide_step4_title': 'Get your Access Token & Phone Number ID',
    'flow.guide_step4_desc':  'Create a System User in Meta Business Suite → Assign your app → Generate a permanent token with whatsapp_business_messaging + whatsapp_business_management permissions. Copy the Token and Phone Number ID.',
    'flow.guide_step5_title': 'Create Message Templates',
    'flow.guide_step5_desc':  'In Meta Business Suite → WhatsApp Manager → Message Templates → Create the templates below. Wait for Meta approval (usually 1–24h).',
    'flow.guide_templates_title': 'Required template names (must match exactly):',
    'flow.guide_templates_desc':  'Create these 4 templates in your WhatsApp Manager. Category: Marketing. Use the same variable order: {{1}} = customer name, {{2}} = product/cart.',
  ...
  tr: {
    ...
    'flow.guide_intro':     'WhatsApp Business hesabınızı bağlamak için şu adımları izleyin:',
    'flow.guide_step1_title': 'Meta Business Hesabı Oluşturun',
    'flow.guide_step1_desc':  'business.facebook.com adresine gidin ve Meta Business hesabınızı oluşturun veya giriş yapın.',
    'flow.guide_step2_title': 'Meta Developer Uygulaması Oluşturun',
    'flow.guide_step2_desc':  'developers.facebook.com/apps → Uygulama Oluştur → İş tipi → WhatsApp ürününü ekleyin.',
    'flow.guide_step3_title': 'WhatsApp Telefon Numarası Ekleyin',
    'flow.guide_step3_desc':  'Uygulamanızda: WhatsApp → Telefon Numaraları → Numara Ekle. Telefon doğrulamasını tamamlayın.',
    'flow.guide_step4_title': 'Erişim Tokenı ve Telefon Numarası ID Alın',
    'flow.guide_step4_desc':  'Meta Business Suite → Sistem Kullanıcıları → Uygulamanızı atayın → whatsapp_business_messaging + whatsapp_business_management izinleriyle kalıcı token oluşturun. Token ve Phone Number ID\'yi kopyalayın.',
    'flow.guide_step5_title': 'Mesaj Şablonları Oluşturun',
    'flow.guide_step5_desc':  'Meta Business Suite → WhatsApp Manager → Mesaj Şablonları → Aşağıdaki şablonları oluşturun. Meta onayını bekleyin (genellikle 1–24 saat).',
    'flow.guide_templates_title': 'Gerekli şablon adları (birebir aynı olmalı):',
    'flow.guide_templates_desc':  'WhatsApp Manager\'da bu 4 şablonu oluşturun. Kategori: Pazarlama. Değişken sırası: {{1}} = müşteri adı, {{2}} = ürün/sepet.',
